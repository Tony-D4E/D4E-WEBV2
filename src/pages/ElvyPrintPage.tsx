          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p style={{ color: '#FFFFFF', textShadow: '0 2px 12px rgba(0,0,0,0.9)' }}
                ...
                {`ElvyPrint est la solution Odoo pour les revendeurs de syst\u00e8mes d'impression : contrats, compteurs, interventions et rentabilit\u00e9 dans un seul outil. D\u00e9ploiement cl\u00e9 en main.`}
              </p>
        ...
        <div ref={featRef} className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-on-scroll ${featVisible ? 'is-visible' : ''}`}>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              {`ElvyPrint couvre l'ensemble du cycle de vie de vos contrats d'impression : de la signature au renouvellement, en passant par chaque relev\u00e9 et chaque intervention.`}
            </p>
          </div>
        ...
        <div ref={intRef} className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-on-scroll ${intVisible ? 'is-visible' : ''}`}>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-300 text-lg">
              {`ElvyPrint s'interface avec les principales solutions de collecte de compteurs et de supervision de flotte du march\u00e9.`}
            </p>
          </div>
          ...
          <div className="bg-white/5 border border-[#F59E0B]/30 rounded-3xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              {`ElvyPrint repose sur Odoo : tout syst\u00e8me disposant d'une API ou d'un export structur\u00e9 peut \u00eatre connect\u00e9. Parlons-en.`}
            </p>
      ...
      <section className="py-24 bg-white">
        <div ref={pourQuiRef} className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-on-scroll ${pourQuiVisible ? 'is-visible' : ''}`}>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-500">
              {`Que vous soyez revendeur, distributeur ou prestataire MPS, ElvyPrint s'adapte \u00e0 votre mod\u00e8le \u00e9conomique.`}
            </p>
          </div>
