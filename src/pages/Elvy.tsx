          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <img src="/antonio-elvy.jpg" alt="Antonio Spedicato - Fondateur D4E"
                className="w-full max-w-xs rounded-3xl object-cover mb-6 shadow-2xl"
                style={{ maxHeight: '350px', border: '3px solid #00D4C8' }} />
              <h2 className="text-3xl font-black mb-1" style={{ color: '#FFFFFF' }}>{`Discutons de votre m\u00e9tier`}</h2>
              <p className="font-bold text-sm mb-4" style={{ color: '#00D4C8' }}>{`Antonio Spedicato \u00b7 Fondateur D4E`}</p>
              <p className="text-base leading-relaxed mb-8 max-w-md" style={{ color: '#E2E8F0' }}>
              ...
              <div className="flex flex-col gap-3 w-full max-w-xs">
                <a href="tel:+41764344595"
                  className="flex items-center justify-center gap-2 px-5 py-3 bg-[#00D4C8] text-white font-bold rounded-xl">
                ...
                <a href="mailto:antonio@d4e.cool"
                  ...
                  style={{ backgroundColor: 'rgba(255,255,255,0.1)', color: '#E2E8F0', border: '1px solid rgba(255,255,255,0.2)' }}>
            ...
            <div>
              <form
                ...
                style={{ backgroundColor: '#0F1D3A', border: '1px solid rgba(255,255,255,0.1)' }}
              >
