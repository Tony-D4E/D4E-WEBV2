...
export function Elvy() {
  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      ...
      <section id="solutions" className="py-24" style={{ backgroundColor: '#0B0F19' }}>
      ...
      <section id="contact" className="py-24 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            {/* Colonne gauche : photo + message + boutons */}
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <img src="/antonio-elvy.jpg" alt="Antonio Spedicato - Fondateur D4E"
                className="w-full max-w-xs rounded-3xl object-cover mb-6 shadow-xl"
                style={{ maxHeight: '350px', border: '3px solid #00D4C8' }} />
              <h2 className="text-3xl font-black mb-1" style={{ color: '#0F1D3A' }}>{`Discutons de votre m\u00e9tier`}</h2>
              <p className="font-bold text-sm mb-4" style={{ color: '#00D4C8' }}>{`Antonio Spedicato \u00b7 Fondateur D4E`}</p>
              ...
              <div className="flex flex-col gap-3 w-full max-w-xs">
                <a href="tel:+41764344595"
                  className="flex items-center justify-center gap-2 px-5 py-3 bg-[#00D4C8] text-white font-bold rounded-xl shadow-md">
                  <Phone className="h-4 w-4" /> +41 (0)76 434 45 95
                </a>
                <a href="https://wa.me/41764344595" target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-5 py-3 bg-[#25D366] text-white font-bold rounded-xl shadow-md">
                ...
                <a href="mailto:antonio@d4e.cool"
                  className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-semibold shadow-sm"
                  style={{ backgroundColor: '#FFFFFF', color: '#0F1D3A', border: '1px solid #E2E8F0' }}>
                  <Mail className="h-4 w-4" /> antonio@d4e.cool
                </a>
              </div>
            </div>

            {/* Colonne droite : formulaire dans bloc sombre */}
            <div>
              <form
                action="https://formspree.io/f/xdawrgoz"
                method="POST"
                className="rounded-3xl p-8 space-y-4 shadow-xl"
