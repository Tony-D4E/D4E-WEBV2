    ...
    <div className="op">
      ...
      <section className="dk" id="top" style={{minHeight:'100vh',display:'flex',alignItems:'center',padding:'120px 48px 80px',overflow:'hidden'}}>
        ...
        <div style={{width:'100%',position:'relative',zIndex:2}}>
          <div className="aos" style={{display:'inline-flex',alignItems:'center',gap:10,background:'rgba(245,158,11,0.12)',border:'1px solid rgba(245,158,11,0.4)',borderRadius:40,padding:'6px 18px',fontSize:13,color:'#F59E0B',fontWeight:700,letterSpacing:.5,textTransform:'uppercase',marginBottom:24}}><span style={{width:8,height:8,borderRadius:'50%',background:'#F59E0B',animation:'opPulse 2s infinite'}}/>Partenaire Odoo Gold — Suisse, France, Espagne</div>
              ...
              <div className="sg aos d3" style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:14,marginBottom:44}}>
                {[
                  ...
                  <div key={i} className="p3">
                    ...
                    <div style={{fontWeight:700,fontSize:15,marginBottom:6,color:'#fff'}}>{p.t}</div>
                    <div style={{fontSize:14,color:'#94A3B8',lineHeight:1.6}}>{p.d}</div>
                  </div>
                ))}
              </div>
              <div className="aos d4" style={{display:'flex',gap:14,flexWrap:'wrap'}}>
                <a href="#" onClick={(e)=>{e.preventDefault();document.getElementById('contact-form')?.scrollIntoView({behavior:'smooth'})}} className="btn-p">Discuter de mon projet</a>
